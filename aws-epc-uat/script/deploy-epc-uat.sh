...
docker stop $(docker ps --filter 'ancestor=charat/go-epc-uat:latest' --format "{{.ID}}")
...
docker run -p 3300:3300 -d charat/go-epc-uat:latest
...
latestVer=` curl --location http://172.51.64.139:3300/apiepc/v1/version |cut -d '"' -f 4`
