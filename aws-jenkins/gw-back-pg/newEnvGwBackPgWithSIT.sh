...
sed -i -e "s|127.0.0.1|172.51.66.196|g" /var/lib/jenkins/workspace/gw-back-pg-sit/src/environments/environment.ts
sed -i -e "s|%release%|${releaseBS}|g" /var/lib/jenkins/workspace/gw-back-pg-sit/src/environments/environment.ts
#debug
