#!/bin/bash
#------
# cd /var/lib/jenkins/workspace/go-epc-uat/src/environments/
...
sed -i -e "s|127.0.0.1|172.51.66.4|g" /var/lib/jenkins/workspace/go-epc-uat/src/environments/environment.ts
sed -i -e "s|Go-Epc-Dev|${releaseBU}|g" /var/lib/jenkins/workspace/go-epc-uat/src/environments/environment.ts
#debug
cat /var/lib/jenkins/workspace/go-epc-uat/src/environments/environment.ts
