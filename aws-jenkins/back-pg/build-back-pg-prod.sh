...
sed -i -e "s/go-back-yyy/go-back-pg-prod/g" /var/lib/jenkins/workspace/go-back-pg-prod/docker-compose.yml
sed -i -e "s/go-back-xxx/go-back-pg-prod/g" /var/lib/jenkins/workspace/go-back-pg-prod/docker-compose.yml
