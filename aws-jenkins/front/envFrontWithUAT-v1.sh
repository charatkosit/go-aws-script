...
sed -i -e "s|%hotjar_id%|${hotjar_id}|g" /var/lib/jenkins/workspace/go-front-uat/src/environments/environment.prod.ts
sed -i -e "s|1234567|${hotjar_id}|g" /var/lib/jenkins/workspace/go-front-uat/src/index.html
