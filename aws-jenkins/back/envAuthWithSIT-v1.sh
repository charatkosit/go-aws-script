#!/bin/bash
#-------
#cd /var/lib/jenkins/workspace/go-auth-sit/src/environments/
...
sed -i -e "s|127.0.0.1|172.41.60.78|g" /var/lib/jenkins/workspace/go-auth-sit/src/environments/environment.ts
