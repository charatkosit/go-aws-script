...
sed -i -e "s|127.0.0.1|172.51.67.165|g" /var/lib/jenkins/workspace/go-back-auth-prod/src/environments/environment.ts
sed -i -e "s|%release%|${releaseBP}|g" /var/lib/jenkins/workspace/go-back-auth-prod/src/environments/environment.ts
#debug
cat /var/lib/jenkins/workspace/go-back-auth-prod/src/environments/environment.ts
