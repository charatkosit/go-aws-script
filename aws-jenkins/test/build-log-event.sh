...
sed -i -e "s/go-back-yyy/logevent/g" /var/lib/jenkins/workspace/test.LogEvent/docker-compose.yml
sed -i -e "s/go-back-xxx/logevent/g" /var/lib/jenkins/workspace/test.LogEvent/docker-compose.yml
